...
import GoogleIcon from "src/assets/LoginScreen/Google.svg";
import { RootRoutes, RootStackScreenProps } from "src/types";
...
type LoginScreenParams = RootStackScreenProps<RootRoutes.Login>;
  ...
  return (
    <View style={Styles.wrap}>
      <SafeAreaView style={Styles.safeArea}>
        ...
        <ImageBackground
          source={require("src/assets/LoginScreen/logo.png")}
          resizeMode="cover"
          style={[Styles.logo, { top: insets.top }]}></ImageBackground>
      </SafeAreaView>
      <AnimatedImageBackground
        source={require("src/assets/LoginScreen/screenBg.png")}
        resizeMode="cover"
        style={[
          Styles.background,
          {
        ...
        <ReAnimated.View
          ...
          <View style={Styles.infoContainer}>
            ...
            <TouchableOpacity
              ...
              <GoogleIcon />
              <Text style={Styles.buttonText}>Вход с аккаунтом Google</Text>
            </TouchableOpacity>
          </View>
        </ReAnimated.View>
      </AnimatedImageBackground>
